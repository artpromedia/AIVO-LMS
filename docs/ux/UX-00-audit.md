...
| ------ | -------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- |
| BF-01  | Parent signup → consent → learner creation   | `/signup` lacks an inline consent step; consent currently lives at `/parent/consent` _after_ the learner already exists. Order-of-operations does not match the journey.                                                                                                                           | High     |
...
**P1 — must ship before enterprise (district) release** 6. DD-05 — Unified per-role Inbox. 7. DD-07 — IEP upload async status + brain-profile timeline. 8. DD-08 — DSAR end-to-end status visibility. 9. DD-13 — Dyslexia-friendly + reduced-motion modes. 10. Learner confusion fixes (§8) — single primary CTA on learner home.

**P2 — quality polish** 11. DD-02 — Per-route-group `not-found.tsx`. 12. DD-09 — `/help` surface. 13. DD-10 — Visual regression screenshot harness. 14. DD-11 — Lint guard for `Card p-5` density bypass. 15. DD-14 — High-contrast theme variant per role.
