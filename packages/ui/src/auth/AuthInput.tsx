 ...
 */
export interface AuthInputProps extends Omit<React.InputHTMLAttributes<HTMLInputElement>, "id"> {
  id: string;
    ...
    <div className="flex flex-col gap-1.5">
      ...
      >
        ...
        <input
          ...
          {...rest}
        />
        {trailing ? <span className="ml-2 text-iw-text-muted">{trailing}</span> : null}
      </div>
      {error ? (
        <p
          id={errorId}
