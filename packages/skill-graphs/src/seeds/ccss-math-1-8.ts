...
export const ccssMath1To8: SkillGraph = {
  ...
  skills: [
    ...
    {
      id: "ccss-math.1.NBT.C.4",
      title: "Add within 100 using place value",
      description: "I can add a two-digit number and a multiple of ten using tens and ones.",
      subject: "math",
      gradeBand: "1",
      frameworkRefs: [{ framework: "CCSS-Math", code: "1.NBT.C.4" }],
    ...
    {
      id: "ccss-math.2.NBT.B.5",
      title: "Fluently add and subtract within 100",
      description: "I can add and subtract two-digit numbers using place value and regrouping.",
      subject: "math",
      gradeBand: "2",
      frameworkRefs: [{ framework: "CCSS-Math", code: "2.NBT.B.5" }],
      prerequisites: ["ccss-math.2.NBT.A.1"],
    },
    {
      id: "ccss-math.2.G.A.1",
      title: "Recognise shapes by their attributes",
      description: "I can name shapes from their number of sides, corners, and faces.",
      subject: "math",
      gradeBand: "2",
      frameworkRefs: [{ framework: "CCSS-Math", code: "2.G.A.1" }],
      prerequisites: [],
    },
    {
