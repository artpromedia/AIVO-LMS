...
const GATES = [
  ...
  { name: "feature-flag:audit", cmd: ["pnpm", "feature-flag:audit"] },
  { name: "audit-trail:audit", cmd: ["pnpm", "audit-trail:audit"] },
  { name: "design-token:audit", cmd: ["pnpm", "design-token:audit"] },
