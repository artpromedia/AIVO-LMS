...
const TRANSLATIONS = {
  ar: {
    ...
    "onboarding.signin.errors.wrong_surface": "يسجّل هذا الحساب الدخول من بوابة مختلفة.",
    "onboarding.signin.errors.unsupported_role": "لا يمكن لهذا النوع من الحسابات تسجيل الدخول هنا.",
    "onboarding.signin.errors.login_failed": "تعذّر تسجيل دخولك. يرجى المحاولة بعد قليل.",
    ...
    "onboarding.signup.errors.unsupported_role": "لا يمكن إنشاء هذا النوع من الحسابات هنا.",
    "onboarding.signup.errors.signup_failed": "تعذّر إنشاء حسابك. يرجى المحاولة مرة أخرى.",
    "onboarding.learner_new.error_first_name": "يرجى إدخال الاسم الأول للمتعلّم للمتابعة.",
  ...
  de: {
    ...
    "onboarding.signin.errors.missing_credentials": "Bitte E-Mail-Adresse und Passwort eingeben.",
    "onboarding.signin.errors.invalid_credentials":
    ...
    "onboarding.signin.errors.unsupported_role": "Dieser Kontotyp kann sich hier nicht anmelden.",
    ...
    "onboarding.signup.errors.unsupported_role": "Dieser Kontotyp kann hier nicht erstellt werden.",
  ...
  es: {
    "onboarding.common.copyright": "© AIVO Learning. Todos los derechos reservados.",
    "onboarding.signin.errors.missing_credentials":
      "Introduce tu correo y contraseña para iniciar sesión.",
    "onboarding.signin.errors.invalid_credentials":
      "Ese correo o contraseña no coinciden. Inténtalo de nuevo.",
    "onboarding.signin.errors.wrong_surface": "Esta cuenta inicia sesión desde otro portal.",
    ...
    "onboarding.signup.errors.unsupported_role": "Este tipo de cuenta no se puede crear aquí.",
    "onboarding.signup.errors.signup_failed": "No pudimos crear tu cuenta. Inténtalo de nuevo.",
    "onboarding.learner_new.error_first_name": "Introduce el nombre del estudiante para continuar.",
  ...
  fr: {
    ...
    "onboarding.signin.errors.wrong_surface": "Ce compte se connecte depuis un autre portail.",
    "onboarding.signin.errors.unsupported_role": "Ce type de compte ne peut pas se connecter ici.",
    "onboarding.signin.errors.login_failed": "Connexion impossible. Réessaie dans un instant.",
    "onboarding.signup.errors.invalid_input":
    ...
    "onboarding.signup.errors.unsupported_role": "Ce type de compte ne peut pas être créé ici.",
    "onboarding.signup.errors.signup_failed": "Impossible de créer ton compte. Réessaie.",
    "onboarding.learner_new.error_first_name": "Saisis le prénom de l’apprenant pour continuer.",
  ...
  hi: {
    ...
    "onboarding.signin.errors.wrong_surface": "यह खाता किसी अन्य पोर्टल से साइन इन करता है।",
    "onboarding.signin.errors.unsupported_role": "इस प्रकार का खाता यहाँ साइन इन नहीं कर सकता।",
    "onboarding.signin.errors.login_failed":
    ...
    "onboarding.signup.errors.unsupported_role": "इस प्रकार का खाता यहाँ नहीं बनाया जा सकता।",
    "onboarding.signup.errors.signup_failed": "हम आपका खाता नहीं बना सके। कृपया पुनः प्रयास करें।",
    "onboarding.learner_new.error_first_name":
  ...
  ja: {
    ...
    "onboarding.signin.errors.wrong_surface": "このアカウントは別のポータルからサインインします。",
    "onboarding.signin.errors.unsupported_role":
    ...
    "onboarding.signup.errors.unsupported_role": "この種類のアカウントはここでは作成できません。",
    "onboarding.signup.errors.signup_failed":
  ...
  ko: {
    ...
    "onboarding.signin.errors.missing_credentials": "로그인하려면 이메일과 비밀번호를 입력하세요.",
    "onboarding.signin.errors.invalid_credentials":
      "이메일 또는 비밀번호가 일치하지 않습니다. 다시 시도해 주세요.",
    "onboarding.signin.errors.wrong_surface": "이 계정은 다른 포털에서 로그인합니다.",
    "onboarding.signin.errors.unsupported_role": "이 계정 유형은 여기에서 로그인할 수 없습니다.",
    "onboarding.signin.errors.login_failed": "로그인할 수 없습니다. 잠시 후 다시 시도해 주세요.",
    "onboarding.signup.errors.invalid_input":
      "이름, 유효한 이메일, 8자 이상의 비밀번호를 입력하세요.",
    "onboarding.signup.errors.email_taken": "이미 등록된 이메일입니다. 로그인을 시도해 보세요.",
    "onboarding.signup.errors.weak_password":
      "이 비밀번호는 보안 정책을 충족하지 않습니다. 숫자와 기호를 포함해 8자 이상을 사용하세요.",
    "onboarding.signup.errors.service_unavailable":
      "가입 서비스에 연결할 수 없습니다. 잠시 후 다시 시도해 주세요.",
    "onboarding.signup.errors.unsupported_role": "이 계정 유형은 여기에서 만들 수 없습니다.",
    "onboarding.signup.errors.signup_failed": "계정을 만들 수 없습니다. 다시 시도해 주세요.",
    "onboarding.learner_new.error_first_name": "계속하려면 학습자의 이름을 입력해 주세요.",
  ...
  pt: {
    "onboarding.common.copyright": "© AIVO Learning. Todos os direitos reservados.",
    "onboarding.signin.errors.missing_credentials": "Insira seu e-mail e sua senha para entrar.",
    "onboarding.signin.errors.invalid_credentials":
      "Esse e-mail ou senha não confere. Tente novamente.",
    "onboarding.signin.errors.wrong_surface": "Esta conta entra a partir de outro portal.",
    "onboarding.signin.errors.unsupported_role": "Este tipo de conta não pode entrar aqui.",
    "onboarding.signin.errors.login_failed": "Não foi possível entrar. Tente de novo em instantes.",
    "onboarding.signup.errors.invalid_input":
      "Insira seu nome, um e-mail válido e uma senha de pelo menos 8 caracteres.",
    "onboarding.signup.errors.email_taken": "Este e-mail já está cadastrado. Tente entrar.",
    "onboarding.signup.errors.weak_password":
    ...
    "onboarding.signup.errors.unsupported_role": "Este tipo de conta não pode ser criado aqui.",
    "onboarding.signup.errors.signup_failed": "Não foi possível criar sua conta. Tente novamente.",
    "onboarding.learner_new.error_first_name":
  ...
  zh: {
    ...
    "onboarding.signin.errors.invalid_credentials": "邮箱或密码不正确。请重试。",
    ...
    "onboarding.signup.errors.invalid_input": "请输入您的姓名、有效邮箱以及至少 8 个字符的密码。",
    "onboarding.signup.errors.email_taken": "该邮箱已注册。请尝试登录。",
    "onboarding.signup.errors.weak_password":
      "此密码不符合我们的安全策略。请使用至少 8 个字符，并包含数字和符号。",
    "onboarding.signup.errors.service_unavailable": "无法连接注册服务。请稍后再试。",
