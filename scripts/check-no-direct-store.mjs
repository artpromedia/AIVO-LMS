...
const MIGRATED_DOMAINS = [
  ...
  {
    domain: "curriculum",
    reposFunctions: ["listSubjects", "getSubjectById", "listSkills", "getSkill", "createSkill", "updateSkill"],
  },
  {
    domain: "compliance",
    reposFunctions: [
  ...
  },
{
    ...
    reposFunctions: [
      ...
      "getActiveLessonObjectiveTemplate",
      "listAssessmentBlueprints",
      "getActiveAssessmentBlueprint",
