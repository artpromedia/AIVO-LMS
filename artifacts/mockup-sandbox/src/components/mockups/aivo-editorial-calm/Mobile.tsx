      ...
      <header className="px-6 pt-14 pb-4 flex justify-between items-center bg-background/80 backdrop-blur-md sticky top-0 z-20">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-secondary overflow-hidden border border-border flex items-center justify-center">
            <img
              src="/__mockup/images/aivo-editorial-calm/feature-quiet.png"
              alt="Profile"
        ...
        <section>
          ...
          <div className="rounded-3xl bg-white p-6 shadow-sm border border-border/40 relative overflow-hidden group">
            ...
            <div className="flex items-center gap-3 mb-5 relative z-10">
              ...
              <span className="font-medium text-sm tracking-wide text-foreground/80 uppercase">
                Current Focus
              </span>
            </div>
            ...
            {[
              {
                ...
                role: "Math",
                color: "bg-[#EAE4D3]",
                icon: <Sparkles className="w-4 h-4 text-[#8A795D]" />,
              },
              {
                name: "Aura",
                role: "Reading",
              ...
              <div
                key={i}
                className="snap-start shrink-0 w-[140px] rounded-2xl bg-white border border-border/40 p-4 shadow-sm flex flex-col items-center text-center"
              >
                <div
                  className={`w-14 h-14 rounded-full ${tutor.color} mb-3 flex items-center justify-center`}
                >
                  {tutor.icon}
                </div>
          ...
          <div className="rounded-2xl bg-secondary/40 p-5 border border-border/50 flex gap-4 items-start">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground font-light leading-relaxed">
                You've been answering spatial questions 20% faster when we use visual models. We'll
                keep doing that.
              </p>
            </div>
          </div>
