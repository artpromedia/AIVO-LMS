...
export function Web() {
  ...
  return (
    <div
      className={`aivo-editorial-calm min-h-screen flex flex-col transition-colors duration-500 ${sensoryMode === "calm" ? "bg-[#F4F1ED]" : ""}`}
    >
      {/* Navigation */}
      <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/80 backdrop-blur-md">
        <div className="container mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="#" className="text-sm font-medium hidden sm:block">
              Log in
            </a>
          ...
          <div className="container mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="max-w-2xl">
                <Badge
                  variant="outline"
                  className="mb-6 rounded-full px-3 py-1 font-normal border-border bg-background"
                >
                ...
                <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl font-light leading-[1.1] mb-8 text-foreground">
                  An education that adapts to <span className="italic text-primary">their</span>{" "}
                  mind.
                </h1>
                <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-10 max-w-xl font-light">
                  AIVO provides every K-8 child with a personal learning companion that understands
                  how they process the world. Designed with neurodiverse families in mind, built for
                  every learner.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button
                    size="lg"
                    className="rounded-full text-base px-8 bg-primary hover:bg-primary/90 border-transparent"
                  >
                    Meet Your Tutor
                  ...
                  <Button
                    size="lg"
                    variant="outline"
                    className="rounded-full text-base px-8 border-border hover:bg-secondary"
                  >
                    Read the Research
                  </Button>
                </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        Switching to visual-first explanations for spatial reasoning concept.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-3xl mx-auto text-center mb-20">
              ...
              <p className="text-lg text-muted-foreground font-light leading-relaxed">
                Traditional education demands that children adapt to the curriculum. AIVO demands
                that the curriculum adapts to the child. Built on foundational research from MIT and
                Stanford.
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-20 items-center">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="p-5 rounded-2xl bg-secondary/50 border border-border/50">
                      ...
                      <p className="text-sm text-muted-foreground mb-4">
                        We noticed you like pizza examples. Let's look at how to share one.
                      </p>
                    ...
                    <div className="space-y-3">
                      <h6 className="text-sm font-medium text-muted-foreground uppercase tracking-wider mb-2">
                        Your Team
                      </h6>
                      {[
              ...
              <div className="order-1 lg:order-2">
                ...
                <p className="text-lg text-muted-foreground font-light leading-relaxed mb-8">
                  We don't use patronizing cartoons or flashing rewards to hold attention. AIVO
                  respects your child's intelligence by offering a clean, beautiful interface that
                  reduces anxiety and elevates focus.
                </p>
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <blockquote className="font-serif text-2xl md:text-4xl font-light leading-tight mb-10">
                "We tried six different platforms for my son, who has ADHD and sensory processing
                differences. Everything was too loud, too fast, or treated him like a baby. AIVO is
                the first tool that feels like it respects him."
              </blockquote>
              <div className="flex items-center justify-center gap-4">
                <div className="w-12 h-12 rounded-full overflow-hidden">
                  <img
                    src="/__mockup/images/aivo-editorial-calm/feature-play.png"
                    alt="Parent"
