...
import { Sparkles, Brain, ShieldCheck, Microscope, ArrowRight, ChevronRight, BookOpen, Star } from "lucide-react";
import "./_group.css";
      ...
      <nav className="fixed top-0 w-full z-50 glass-panel border-b-0 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 font-medium text-sm text-muted-foreground">
            ...
            <a href="#" className="hover:text-primary transition-colors">For Districts</a>
            <a href="#" className="hover:text-primary transition-colors">The Science</a>
            <a href="#" className="hover:text-primary transition-colors">About Us</a>
          </div>
          
          <div className="flex items-center gap-4">
            <Button variant="ghost" className="text-white hover:text-primary hidden md:inline-flex">Log In</Button>
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-6 overflow-hidden bg-aurora">
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center relative z-10">
          <div className="max-w-2xl">
            <Badge variant="outline" className="mb-6 font-display border-primary/30 text-primary bg-primary/5 py-1 px-3">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed max-w-lg">
              AIVO pairs neurodiverse children with 14 specialized AI tutors that adapt to their unique functioning level. Not just an app—a glowing constellation of learning that grows with them.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="font-display text-lg bg-primary hover:bg-primary/90 text-primary-foreground border-none px-8">
                Explore the Platform <ArrowRight className="ml-2 w-5 h-5" />
              </Button>
              <Button size="lg" variant="outline" className="font-display text-lg border-muted-foreground/30 text-white hover:bg-white/5">
            ...
            <div className="mt-10 flex items-center gap-4 text-sm text-muted-foreground">
              <div className="flex -space-x-2">
                {[1,2,3,4].map(i => (
                  <div key={i} className="w-8 h-8 rounded-full border border-background bg-muted flex items-center justify-center overflow-hidden">
                    <img src={`https://api.dicebear.com/7.x/avataaars/svg?seed=parent${i}&backgroundColor=1e2337`} alt="Parent avatar" className="w-full h-full opacity-80" />
                  </div>
                ))}
              </div>
            ...
            <div className="absolute inset-0 rounded-2xl overflow-hidden glass-panel animate-pulse-glow">
              ...
              <div className="absolute bottom-6 left-6 right-6 glass-panel rounded-xl p-4 flex items-center gap-4 animate-float">
                ...
                <div>
                  ...
                  <p className="text-xs text-primary">Adapting to visual-spatial learning style...</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground text-lg">
              Every child processes the world differently. AIVO creates a secure, private computational model of how your child learns best—mapping their strengths, sensory preferences, and cognitive patterns.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 md:order-2">
            ...
            <p className="text-muted-foreground text-lg mb-8">
              While the child interacts with friendly, celestial guides, the AIVO engine is continuously analyzing response times, error patterns, and engagement metrics. 
            </p>
      ...
      <section className="py-24 px-6 relative bg-gradient-to-b from-background to-[#0b0f19]">
        <div className="max-w-4xl mx-auto text-center glass-panel rounded-3xl p-12 border-primary/20 relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Button size="lg" className="font-display text-lg bg-primary hover:bg-primary/90 text-primary-foreground border-none">
              Start Free Trial
            </Button>
            <Button size="lg" variant="outline" className="font-display text-lg border-muted-foreground/30 text-white">
