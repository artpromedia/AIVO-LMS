      ...
      <nav className="border-b border-slate-200 bg-white/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex gap-8 text-sm font-medium text-slate-500">
            <a href="#how" className="hover:text-slate-800 transition-colors">
              How it works
            </a>
            <a href="#tutors" className="hover:text-slate-800 transition-colors">
              The 14 Tutors
            </a>
            <a href="#stories" className="hover:text-slate-800 transition-colors">
              Stories
            </a>
          </div>
          <div className="flex gap-4">
            <Button
              variant="ghost"
              className="text-slate-600 font-medium hidden sm:flex hover:bg-slate-50 border-slate-200"
            >
              Log in
            </Button>
            <Button className="bg-[hsl(var(--primary))] hover:bg-[hsl(var(--primary)/0.9)] text-white font-medium">
              Start Free Month
            </Button>
          </div>
        </div>
      ...
      <section className="px-6 py-24 md:py-32 max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-16">
        <div className="flex-1 space-y-8 text-center md:text-left">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium tracking-tight text-slate-800 leading-[1.1]">
            AI learning that adapts to how{" "}
            <span className="text-[hsl(var(--secondary))]">your child</span> learns.
          </h1>
          <p className="text-lg text-slate-600 max-w-xl mx-auto md:mx-0 leading-relaxed">
            A calm, predictable educational environment built specifically for neurodiverse minds.
            AIVO learns your child's unique sensory and cognitive profile to provide a tailored
            learning experience.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
            ...
            <Button
              variant="outline"
              className="border-slate-300 text-slate-600 font-medium px-8 py-6 text-base h-auto hover:bg-slate-50"
            >
              Read the Research
            </Button>
          </div>
        ...
        <div className="flex-1 w-full max-w-md md:max-w-none">
          <div className="aspect-square md:aspect-[4/3] rounded-2xl overflow-hidden border border-slate-200 bg-slate-100 flex items-center justify-center">
            ...
            <img
              src="/__mockup/images/nd-calm-hero.png"
              alt="A child learning peacefully with a tablet"
      ...
      <section className="border-y border-slate-200 bg-white">
        <div className="max-w-6xl mx-auto px-6 py-12 text-center space-y-6">
          <p className="text-sm font-medium text-slate-400 uppercase tracking-widest">
            Designed alongside specialists, trusted by parents
          </p>
        ...
        <div className="max-w-6xl mx-auto space-y-16">
          <div className="text-center space-y-4 max-w-2xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-medium text-slate-800">
              A structured approach to individualized learning
            </h2>
            <p className="text-slate-600">
              We replace overwhelming interfaces with a quiet, purposeful system that meets your
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={i}
                className="bg-white border border-slate-200 p-8 rounded-xl space-y-4 text-center md:text-left"
              >
        ...
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
          <div className="flex-1 space-y-12">
            <div className="space-y-4">
              <h2 className="text-3xl md:text-4xl font-medium text-slate-800">
                Clear, predictable progress. Every day.
              </h2>
              <p className="text-slate-600">
                You remain in control of the learning journey while AIVO handles the specific
                educational pacing.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: "You configure the initial sensory preferences and functioning level.",
                },
                {
                  step: "02",
                  title: "Match & Learn",
                  desc: "Your child meets their assigned tutors in short, focused sessions.",
                },
                {
                  step: "03",
                  title: "Daily Review",
                  desc: "Review progress and adjust settings from your quiet parent dashboard.",
                },
              ].map((item, i) => (
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white border border-slate-200 p-8 rounded-xl space-y-6">
              <p className="text-slate-600 leading-relaxed">
                "Other apps were too noisy and overstimulating. The reduced-motion setting and
                consistent layout of AIVO means my son actually focuses on the learning, not the
                interface. The tutors feel safe to him."
              </p>
              <div className="flex items-center gap-4 pt-4 border-t border-slate-100">
                <div className="w-10 h-10 bg-slate-200 rounded-full overflow-hidden">
                  <img
                    src="/__mockup/images/nd-calm-testimonial-1.png"
                    alt="Sarah"
                    className="w-full h-full object-cover"
                  />
                </div>
            ...
            <div className="bg-white border border-slate-200 p-8 rounded-xl space-y-6">
              <p className="text-slate-600 leading-relaxed">
                "The parent dashboard is honest and clear. I don't get meaningless 'points' or
                gamification—I get actual updates on what cognitive skills the system is adapting
                to. It feels like a tool, not a toy."
              </p>
              <div className="flex items-center gap-4 pt-4 border-t border-slate-100">
                <div className="w-10 h-10 bg-slate-200 rounded-full overflow-hidden">
                  <img
                    src="/__mockup/images/nd-calm-testimonial-2.png"
                    alt="David"
                    className="w-full h-full object-cover"
                  />
                </div>
      ...
      <section className="border-t border-slate-200 bg-white">
        <div className="max-w-4xl mx-auto px-6 py-24 text-center space-y-8">
          ...
          <p className="text-slate-600 text-lg max-w-2xl mx-auto">
            AIVO is built strictly to WCAG AA standards. No unexpected sounds, no forced animations,
            clear contrast, and predictable navigation.
          </p>
