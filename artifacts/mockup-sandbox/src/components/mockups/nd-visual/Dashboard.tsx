...
const childProfile = {
  ...
  level: "Level 3",
  levelColor:
    "bg-[hsl(var(--visual-primary-light))] text-[hsl(var(--visual-primary))] border-[hsl(var(--visual-primary))]/20",
  sensory: {
    audio: "Low",
    visual: "High",
    movement: "Medium",
...
const tutors = [
  {
    ...
    role: "Math Explorer",
    color:
      "bg-[hsl(var(--visual-math))]/10 text-[hsl(var(--visual-math))] border-[hsl(var(--visual-math))]/20",
    iconColor: "text-[hsl(var(--visual-math))]",
    lastSeen: "Today",
  },
  {
    id: 2,
    ...
    role: "Reading Guide",
    color:
      "bg-[hsl(var(--visual-reading))]/10 text-[hsl(var(--visual-reading))] border-[hsl(var(--visual-reading))]/20",
  ...
  },
  {
    ...
    role: "Science Buddy",
    color:
      "bg-[hsl(var(--visual-science))]/10 text-[hsl(var(--visual-science))] border-[hsl(var(--visual-science))]/20",
    iconColor: "text-[hsl(var(--visual-science))]",
    lastSeen: "2 days ago",
  },
  {
    id: 4,
    ...
    color:
      "bg-[hsl(var(--visual-sel))]/10 text-[hsl(var(--visual-sel))] border-[hsl(var(--visual-sel))]/20",
...
const recentSessions = [
  ...
  },
  {
    ...
    bg: "bg-[hsl(var(--visual-reading))]/10",
  },
];
    ...
    <div className="nd-visual min-h-screen pb-20 md:pb-8 flex flex-col md:flex-row">
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 p-4 flex justify-around items-center z-50 md:relative md:w-24 md:flex-col md:border-t-0 md:border-r md:justify-start md:pt-8 md:gap-8 shadow-[0_-4px_20px_rgba(0,0,0,0.05)] md:shadow-none">
        <div className="hidden md:flex mb-8">
          <div className="w-12 h-12 bg-[hsl(var(--visual-primary))] rounded-2xl flex items-center justify-center text-white font-bold text-xl transform rotate-3">
            A
          </div>
        </div>
      ...
      <main className="flex-1 p-4 md:p-8 max-w-7xl mx-auto w-full flex flex-col gap-6 md:gap-8 overflow-y-auto">
        ...
        <header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl flex items-center gap-2">Leo's Dashboard</h1>
              <div className="flex flex-wrap items-center gap-2 mt-1">
                <Badge
                  className={`${childProfile.levelColor} px-3 py-1 text-sm border font-bold hover:bg-transparent`}
                >
                ...
                <div className="flex gap-1">
                  <Badge variant="outline" className="bg-white border-gray-200 text-gray-600">
                    <HelpCircle size={12} className="mr-1" /> Audio: {childProfile.sensory.audio}
                  </Badge>
                  <Badge variant="outline" className="bg-white border-gray-200 text-gray-600">
                    <Heart size={12} className="mr-1" /> Visual: {childProfile.sensory.visual}
                  </Badge>
                </div>
              </div>
            </div>
          ...
          <div className="flex gap-3">
            <Button
              variant="outline"
              className="nd-visual-button bg-white border-2 border-gray-100 h-12 px-6 shadow-sm"
            >
          ...
          <div className="md:col-span-8 flex flex-col gap-6 md:gap-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              <Card className="nd-visual-card border-none bg-gradient-to-br from-[hsl(var(--visual-math))]/10 to-[hsl(var(--visual-math))]/5">
                <CardContent className="p-5 flex flex-col items-center justify-center text-center h-full">
                  ...
                  <h3 className="text-3xl font-black text-[hsl(var(--visual-math))] leading-none">
                    {stats.minutesToday}
                  </h3>
              ...
              <Card className="nd-visual-card border-none bg-gradient-to-br from-[hsl(var(--visual-sel))]/10 to-[hsl(var(--visual-sel))]/5">
                <CardContent className="p-5 flex flex-col items-center justify-center text-center h-full">
                  ...
                  <h3 className="text-3xl font-black text-[hsl(var(--visual-sel))] leading-none">
                    {stats.streak}
                  </h3>
                  <p className="text-sm font-bold text-gray-600 mt-1 uppercase tracking-wide">
                    Day Streak
            ...
            <Card className="nd-visual-card overflow-hidden relative">
              ...
              <CardContent className="p-8 flex flex-col sm:flex-row items-center justify-between gap-6 relative z-10">
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    <Badge className="bg-[hsl(var(--visual-reading))] hover:bg-[hsl(var(--visual-reading))] mb-2 px-3 py-1 font-bold text-sm uppercase tracking-wider">
                      Up Next
                    </Badge>
                    <h2 className="text-2xl font-black text-gray-800 mb-1">Reading with Atlas</h2>
                    <p className="text-gray-600 font-medium">
                      Continue the phonics adventure. About 15 minutes.
                    </p>
                  </div>
                </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                ...
                <Button
                  variant="ghost"
                  className="text-[hsl(var(--visual-primary))] font-bold uppercase tracking-wider text-sm hover:bg-[hsl(var(--visual-primary))]/10 rounded-full"
                >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                {tutors.map((tutor) => (
                  <Card
                    key={tutor.id}
                    className={`nd-visual-card border-2 ${tutor.color} bg-white cursor-pointer hover:border-opacity-50`}
                  >
                    <CardContent className="p-4 flex flex-col items-center text-center">
                      <div
                        className={`w-16 h-16 rounded-full ${tutor.color.split(" ")[0]} flex items-center justify-center mb-3 ${tutor.iconColor}`}
                      >
                      ...
                      <Badge variant="secondary" className="mt-3 bg-white/50 text-xs">
                        {tutor.lastSeen}
                      </Badge>
                    </CardContent>
                  </Card>
              ...
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-[hsl(var(--visual-primary))]">
                      Level {brainClone.level} Intelligence
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-5">
                  <div>
                    <div className="flex justify-between text-sm font-bold mb-2">
                      ...
                      <span className="text-[hsl(var(--visual-primary))]">
                        {brainClone.progress}%
                      </span>
                    </div>
                    <Progress
                      value={brainClone.progress}
                      className="h-3 bg-white [&>div]:bg-[hsl(var(--visual-primary))]"
                    />
                  </div>
                ...
                <div className="space-y-4">
                  {recentSessions.map((session) => (
                    <div key={session.id} className="flex items-center gap-4">
                      <div
                        className={`w-12 h-12 rounded-2xl ${session.bg} ${session.color} flex items-center justify-center flex-shrink-0`}
                      >
                        <session.icon size={20} strokeWidth={2.5} />
                      </div>
                      <div className="flex-1">
                        <h4 className="font-bold text-sm text-gray-800">
                          {session.subject} w/ {session.tutor}
                        </h4>
                        <p className="text-xs font-bold text-gray-500 uppercase tracking-wide">
                          {session.duration} • Mood: {session.mood}
                        </p>
                      </div>
                    </div>
                  ))}
