...
import { ArrowRight, CheckCircle2, KeyRound, Mail, ShieldCheck, UserCircle2 } from "lucide-react";
        ...
        <div className="relative z-10">
          ...
          <div className="space-y-6 max-w-md">
            ...
            <p className="text-lg text-[hsl(var(--accent))]/80 leading-relaxed">
              Log in to see your child's latest progress, review IEP goals, or start a new learning
              adventure.
            </p>
          </div>
        </div>
          ...
          <div className="relative mx-auto w-full max-w-[400px]">
            ...
            <div className="absolute -right-8 bottom-12 bg-white text-[hsl(var(--primary))] p-4 rounded-xl shadow-xl z-20 w-64 border border-[hsl(var(--border))]">
              <p className="text-sm font-medium leading-snug mb-2">
                "AIVO has completely transformed how we approach homework. No more tears!"
              </p>
        ...
        <div className="w-full max-w-md bg-white p-8 sm:p-10 rounded-3xl shadow-xl border border-[hsl(var(--border))] relative z-10">
          ...
          {activeTab === "email" ? (
            <form className="space-y-5">
              <div>
                <label className="block text-sm font-bold text-[hsl(var(--primary))] mb-2">
                  Email Address
                </label>
                <input
                  type="email"
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  <label className="block text-sm font-bold text-[hsl(var(--primary))]">
                    Password
                  </label>
                  <a
                    href="#"
                    className="text-xs font-bold text-[hsl(var(--ring))] hover:text-[hsl(var(--ring-hover))]"
                  >
                    Forgot password?
                  </a>
                </div>
              ...
              <div className="text-center mt-6 text-sm text-[hsl(var(--muted-foreground))]">
                ...
                <a
                  href="#"
                  className="font-bold text-[hsl(var(--ring))] hover:text-[hsl(var(--ring-hover))]"
                >
                  Create account
                </a>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="text-center">
                <label className="block text-sm font-bold text-[hsl(var(--primary))] mb-4">
              ...
              <div className="flex justify-center gap-3 mb-6">
                {[0, 1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className={`w-12 h-14 rounded-xl flex items-center justify-center text-2xl font-bold border-2 ${pin.length > i ? "bg-[hsl(var(--primary))] text-white border-[hsl(var(--primary))]" : "bg-[hsl(var(--accent))] border-transparent text-transparent"}`}
                  >
                    {pin.length > i ? "•" : ""}
                  </div>
                ))}
