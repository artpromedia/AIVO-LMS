...
export function Web() {
  ...
  return (
    <div className={`aivo-inclusive-warm min-h-screen bg-background text-foreground transition-colors duration-500 font-sans ${
      sensoryMode === "calm" ? "sensory-calm" : sensoryMode === "high-contrast" ? "high-contrast" : ""
    }`}>
      {/* Navigation */}
        ...
        <div className="container mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              <Button className="rounded-full bg-primary hover:bg-primary/90 font-medium px-6">Start Trial</Button>
            </div>
        ...
        <section className="pt-24 pb-32 overflow-hidden relative">
          ...
          <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-2xl relative z-10">
              <Badge variant="outline" className="mb-8 py-2 px-4 rounded-full border-primary/20 bg-white/60 text-primary font-semibold shadow-sm backdrop-blur-sm">
              ...
              <p className="text-xl text-muted-foreground mb-10 leading-relaxed font-medium">
                AIVO is the first AI learning platform engineered explicitly for neurodiverse cognitive profiles. We build a personalized "brain-clone" that models how your K-8 child learns best.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" className="h-14 px-8 text-base rounded-full bg-primary hover:bg-primary/90 shadow-lg shadow-primary/20">
                  Start Family Trial <ArrowRight className="ml-2 w-5 h-5" />
                </Button>
                <Button size="lg" variant="outline" className="h-14 px-8 text-base rounded-full bg-white/50 border-primary/20 hover:bg-white text-primary">
        ...
        <section className="py-32">
          <div className="container mx-auto px-6 grid md:grid-cols-2 gap-20 items-center">
            ...
            <div>
              ...
              <p className="text-xl text-muted-foreground mb-10 leading-relaxed font-medium">
                Most EdTech builds for the "average" student and patches on accessibility later. We started with the most complex cognitive profiles — autism, ADHD, sensory processing differences — and built an engine that dynamically scales to any mind.
              </p>
        ...
        <section className="py-32 bg-white/50">
          <div className="container mx-auto px-6">
            <div className="flex flex-col items-center text-center mb-20">
              ...
              <h2 className="text-4xl md:text-5xl font-bold">The relief of feeling <span className="relative inline-block px-1"><span className="relative z-10">understood</span><span className="absolute bottom-1 left-0 w-full h-3 bg-secondary/40 rounded-lg -z-0"></span></span>.</h2>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-10 max-w-6xl mx-auto">
              <Card className="bg-card border-border/50 shadow-lg rounded-[2.5rem] p-4">
                <CardContent className="p-8">
                  ...
                  <p className="text-xl mb-8 leading-relaxed font-medium">
                    "My 8-year-old has profound ADHD and dyslexia. Every other app felt like a slot machine — too loud, too fast. AIVO is the first platform that slows down when he gets overwhelmed. It's not just a learning app, it's a regulated environment."
                  </p>
                  <div className="flex items-center gap-4">
                    <div className="w-14 h-14 rounded-full bg-secondary/20 flex items-center justify-center font-bold text-lg text-secondary-foreground">S.T.</div>
                    <div>
              ...
              <Card className="bg-card border-border/50 shadow-lg rounded-[2.5rem] p-4">
                <CardContent className="p-8">
                  ...
                  <p className="text-xl mb-8 leading-relaxed font-medium">
                    "We use the 'Calm' sensory mode exclusively. For an autistic learner, removing the visual clutter isn't a nice-to-have, it's the difference between learning and melting down. The data tracking for his IEP is phenomenal."
                  </p>
                  <div className="flex items-center gap-4">
                    <div className="w-14 h-14 rounded-full bg-primary/10 flex items-center justify-center font-bold text-lg text-primary">M.R.</div>
                    <div>
                      <p className="font-bold text-lg">Dr. Marcus R.</p>
                      <p className="font-medium text-muted-foreground">Special Education Director & Parent</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <CardContent className="p-0 relative z-10">
                <div className="grid md:grid-cols-2">
                  <div className="p-16 md:p-24 flex flex-col justify-center">
                    <h2 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Ready to clone their brilliance?</h2>
                    <p className="text-primary-foreground/80 mb-10 text-xl font-medium leading-relaxed">
                      Start with a comprehensive baseline assessment. No credit card required for the first 14 days.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4">
                      <Button size="lg" className="h-14 bg-secondary text-secondary-foreground hover:bg-secondary/90 rounded-full text-base font-bold shadow-lg px-8">
                        Start Family Trial
                      </Button>
                      <Button size="lg" variant="outline" className="h-14 text-white border-white/30 hover:bg-white/10 rounded-full text-base font-semibold px-8">
        ...
        <div className="container mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm font-medium text-muted-foreground">
              ...
              <li><a href="#" className="hover:text-primary transition-colors">Sensory controls</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm font-medium text-muted-foreground">
              <li><a href="#" className="hover:text-primary transition-colors">Research library</a></li>
              <li><a href="#" className="hover:text-primary transition-colors">IEP integration</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm font-medium text-muted-foreground">
              ...
              <li><a href="#" className="hover:text-primary transition-colors">COPPA compliance</a></li>
            </ul>
          </div>
        </div>
