  ...
  return (
    <div className="cosmic-friendly min-h-[100dvh] w-full max-w-[390px] mx-auto overflow-hidden flex flex-col font-sans bg-background relative shadow-[0_0_50px_rgba(0,0,0,0.1)] rounded-[2.5rem] border-[6px] border-gray-900 ring-1 ring-border">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="glowing-star top-[40%] left-[10%] animate-pulse-soft bg-secondary"
      ...
      <div className="flex-1 overflow-y-auto px-6 pb-28 scrollbar-hide z-10">
        ...
        <div className="mt-2 mb-8">
          <h2 className="font-display text-[13px] font-bold text-muted-foreground uppercase tracking-widest mb-3">
        ...
        <div className="mb-8">
          <div className="flex justify-between items-end mb-3">
            <h2 className="font-display text-[13px] font-bold text-muted-foreground uppercase tracking-widest">
              Your Guides
            </h2>
          ...
          <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-hide -mx-6 px-6">
            {[
              ...
              <div
                key={i}
                className="flex-shrink-0 w-28 rounded-3xl bg-white border border-border/50 soft-shadow p-5 flex flex-col items-center justify-center text-center animate-float"
                style={{ animationDelay: `${i * 0.5}s` }}
              >
                <div
                  className={`w-14 h-14 rounded-[1.25rem] ${tutor.bg} flex items-center justify-center mb-3`}
                >
        ...
        <div>
          ...
          <div className="space-y-3">
            {[
              ...
              <div
                key={i}
                className="bg-white border border-border/50 soft-shadow rounded-2xl p-4 flex items-center gap-4 cursor-pointer active:scale-[0.98] transition-transform"
              >
                <div
