    ...
    async rewrites() {
      return [
        ...
        { source: "/api/consent/:path*", destination: `${IDENTITY_SVC_URL}/api/consent/:path*` },
        {
          ...
          destination: `${IDENTITY_SVC_URL}/api/curriculum/:path*`,
        },
        {
          source: "/api/assessments/:path*",
          destination: `${ASSESSMENT_SVC_URL}/api/assessments/:path*`,
        },
        ...
        { source: "/api/family/:path*", destination: `${FAMILY_SVC_URL}/api/family/:path*` },
        {
          ...
          destination: `${ENGAGEMENT_SVC_URL}/api/engagement/:path*`,
        },
        ...
        { source: "/api/i18n/:path*", destination: `${I18N_SVC_URL}/api/i18n/:path*` },
        {
          ...
          destination: `${INTEGRATIONS_SVC_URL}/api/integrations/:path*`,
        },
        ...
        {
          source: "/mockup-canvas/:path*",
          destination: "http://localhost:8000/mockup-canvas/:path*",
        },
