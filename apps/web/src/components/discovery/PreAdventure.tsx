          ...
          <div className="relative">
            ...
            <div className="mb-6" key={displayIdx}>
              <div className="flex flex-col items-center gap-3">
                <div
                  className="w-24 h-24 rounded-3xl overflow-hidden border-4 shadow-lg"
                  style={{ borderColor: displayIntro.color }}
                >
                  <Image
                    src={displayTutor.avatar}
                    alt={displayIntro.name}
                    width={96}
                    height={96}
              ...
              {TUTOR_INTROS.map((intro, idx) => {
                ...
                return (
                  <button
                    ...
                    aria-label={
                      isRevealed
                        ? `Replay ${intro.name}'s intro`
                        : `${intro.name} — not yet revealed`
                    }
                  ...
                  >
                    <Image
                      src={TUTORS[intro.tutorKey].avatar}
                      alt={intro.name}
                      width={40}
                      height={40}
                      className="object-cover"
