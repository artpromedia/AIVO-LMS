  ...
  const subtitle =
    mode === "webauthn"
      ...
      : mode === "totp"
        ...
        : mode === "recovery"
          ? "Use one of the single-use codes saved when you set up MFA."
          : t("code_sent_desc");
              ...
              {mode === "webauthn" ? (
                ...
                >
                  <path
                    ...
                    strokeWidth={1.5}
                    d="M12 11c0-1.1.9-2 2-2s2 .9 2 2v2h-4v-2zM6 11c0-3.31 2.69-6 6-6s6 2.69 6 6v2h2v8H4v-8h2v-2z"
                  />
                </svg>
              ) : mode === "totp" ? (
                <svg
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth={1.5}
                    d="M15 7a4 4 0 11-8 0 4 4 0 018 0zm6 12c0-3-2-5-5-5H8c-3 0-5 2-5 5"
                  />
                </svg>
              ) : (
                <svg
