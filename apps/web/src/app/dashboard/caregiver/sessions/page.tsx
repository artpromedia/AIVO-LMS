      ...
      {loadingData ? (
        ...
        <div className="vi-card p-12 text-center">
          ...
          <p className="text-sm vi-text-muted mt-2">
            Connect with learners to view their session history.
          </p>
        </div>
      ) : (
        <>
          ...
          <div className="vi-card overflow-hidden p-0">
            {loadingSessions ? (
              <div className="p-12 text-center">
                <div className="animate-pulse vi-text-muted" role="status">
                  Loading sessions...
                </div>
              </div>
            ) : sessions.length === 0 ? (
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {sessions.map((s) => (
                    <tr
                      key={s.id}
                      className="border-b vi-border hover:bg-[hsl(var(--visual-surface-soft)/0.5)]"
                    >
                      ...
                      <td className="px-6 py-3">
                        <span
                          className={`inline-flex items-center gap-1.5 px-3 py-1.5 text-xs rounded-full font-bold ${s.status === "COMPLETED" ? "bg-[hsl(var(--visual-science)/0.12)] text-[hsl(var(--visual-science))]" : s.status === "CONTENT_READY" ? "bg-[hsl(var(--visual-reading)/0.12)] text-[hsl(var(--visual-reading))]" : "bg-[hsl(var(--visual-sel)/0.16)] text-[hsl(var(--visual-sel))]"}`}
                        >
