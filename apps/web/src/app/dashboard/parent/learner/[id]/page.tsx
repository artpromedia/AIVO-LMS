...
export default function LearnerHubPage() {
  ...
  useEffect(() => {
    ...
    fetch(`/api/family/streaks/${learnerId}`, {
      headers: { Authorization: `Bearer ${accessToken}` },
    })
      .then((r) => (r.ok ? r.json() : null))
      .then((data) => {
  ...
  if (loadingLearner) {
    return (
      <div className="text-center py-20 vi-text-muted animate-pulse">{t("loading_learner")}</div>
    );
  }
    ...
    return (
      <div className="text-center py-20">
        ...
        <Link
          ...
          className="text-sm text-[hsl(var(--visual-primary))] font-semibold hover:underline mt-2 inline-block"
        >
          {t("back_to_dashboard")}
        </Link>
      </div>
  ...
  if (pendingReview) {
    RIGHT_NOW_CARDS.push({
      ...
      label: `Review ${learner.name}'s Brain Profile`,
      description: "AIVO updated the brain profile based on recent sessions.",
      href: `/dashboard/parent/learner/${learnerId}/brain-review`,
      color:
        "bg-[hsl(var(--visual-sel)/0.12)] border-[hsl(var(--visual-sel)/0.3)] text-[hsl(var(--visual-sel))]",
    });
  }
  if (!baselineCompleted && !hasBrain) {
    RIGHT_NOW_CARDS.push({
      ...
      description: "Help AIVO understand your child's learning needs (10 min).",
      href: `/dashboard/parent/learner/${learnerId}/assessment`,
      color:
        "bg-[hsl(var(--visual-reading)/0.12)] border-[hsl(var(--visual-reading)/0.3)] text-[hsl(var(--visual-reading))]",
    });
  }
  if (RIGHT_NOW_CARDS.length === 0) {
    RIGHT_NOW_CARDS.push({
      ...
      label: `${learner.name} is on track!`,
      description: "Everything's looking great. Keep it up!",
      href: "",
      color:
        "bg-[hsl(var(--visual-science)/0.12)] border-[hsl(var(--visual-science)/0.3)] text-[hsl(var(--visual-science))]",
    });
  }
    ...
    <div className="space-y-6">
        ...
        {RIGHT_NOW_CARDS.map((card, i) => {
          const inner = (
            <div className="flex items-center gap-3">
              <span
                className={`w-11 h-11 rounded-2xl ${card.iconWrap} flex items-center justify-center shrink-0 shadow-sm`}
              >
          ...
          return card.href ? (
            <Link
              key={i}
              href={card.href}
              className={`block rounded-2xl p-4 border-2 ${card.color} hover:shadow-md transition`}
            >
              {inner}
            </Link>
          ) : (
      ...
      <div className="vi-card p-5">
        ...
        <div className="grid grid-cols-4 md:grid-cols-7 gap-3">
          ...
          {(
            getTutorsForTier(learner?.gradeLevel ? gradeToTier(learner.gradeLevel) : "EARLY") as [
              TutorKey,
            ...
            .map(([key, tutor]) => (
              ...
              >
                <div
                  className="w-12 h-12 rounded-full overflow-hidden border-2 group-hover:scale-110 transition-transform shadow"
                ...
                <span className="text-[10px] font-heading font-bold vi-text-muted group-hover:text-[hsl(var(--visual-primary))] transition">
                  {tutor.name}
                </span>
              </button>
            ))}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <div className="space-y-1">
              <Link
                href={`/dashboard/parent/learner/${learnerId}/progress`}
                className="block px-3 py-2.5 rounded-lg hover:bg-[hsl(var(--visual-primary)/0.08)] text-sm font-semibold vi-text hover:text-[hsl(var(--visual-primary))] transition"
                style={{ minHeight: 44 }}
              >
                Progress & XP
              </Link>
              ...
              <Link
                href={`/dashboard/parent/learner/${learnerId}/insights`}
                className="block px-3 py-2.5 rounded-lg hover:bg-[hsl(var(--visual-primary)/0.08)] text-sm font-semibold vi-text hover:text-[hsl(var(--visual-primary))] transition"
                style={{ minHeight: 44 }}
              >
                Insights
              ...
              <Link
                href={`/dashboard/parent/learner/${learnerId}/homework`}
                className="block px-3 py-2.5 rounded-lg hover:bg-[hsl(var(--visual-primary)/0.08)] text-sm font-semibold vi-text hover:text-[hsl(var(--visual-primary))] transition"
                style={{ minHeight: 44 }}
              >
                Homework History
              ...
              <Link
                href={`/dashboard/parent/learner/${learnerId}/curriculum`}
                className="block px-3 py-2.5 rounded-lg hover:bg-[hsl(var(--visual-primary)/0.08)] text-sm font-semibold vi-text hover:text-[hsl(var(--visual-primary))] transition"
                style={{ minHeight: 44 }}
              >
                Weekly Curriculum
          ...
          <div>
            ...
            <div className="space-y-1">
              ...
              <Link
                href={`/dashboard/parent/learner/${learnerId}/brain-history`}
                className="block px-3 py-2.5 rounded-lg hover:bg-[hsl(var(--visual-primary)/0.08)] text-sm font-semibold vi-text hover:text-[hsl(var(--visual-primary))] transition"
                style={{ minHeight: 44 }}
              >
                Brain History
              ...
              <Link
                href={`/dashboard/parent/learner/${learnerId}/settings`}
                className="block px-3 py-2.5 rounded-lg hover:bg-[hsl(var(--visual-primary)/0.08)] text-sm font-semibold vi-text hover:text-[hsl(var(--visual-primary))] transition"
                style={{ minHeight: 44 }}
              >
          ...
          <div>
            ...
            <div className="space-y-1">
              ...
              <Link
                href={`/dashboard/parent/learner/${learnerId}/team`}
                className="block px-3 py-2.5 rounded-lg hover:bg-[hsl(var(--visual-primary)/0.08)] text-sm font-semibold vi-text hover:text-[hsl(var(--visual-primary))] transition"
                style={{ minHeight: 44 }}
              >
                Learning Team
              ...
              <Link
                href={`/dashboard/parent/learner/${learnerId}/transitions`}
                className="block px-3 py-2.5 rounded-lg hover:bg-[hsl(var(--visual-primary)/0.08)] text-sm font-semibold vi-text hover:text-[hsl(var(--visual-primary))] transition"
                style={{ minHeight: 44 }}
              >
                Transition Planning
          ...
          <div>
            ...
            <div className="space-y-1">
              <Link
                href={`/dashboard/parent/learner/${learnerId}/milestones`}
                className="block px-3 py-2.5 rounded-lg hover:bg-[hsl(var(--visual-primary)/0.08)] text-sm font-semibold vi-text hover:text-[hsl(var(--visual-primary))] transition"
                style={{ minHeight: 44 }}
              >
                Milestones & Badges
