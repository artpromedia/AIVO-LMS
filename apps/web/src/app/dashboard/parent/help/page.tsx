  ...
  return (
    <div className="max-w-3xl mx-auto px-4 lg:px-6 py-6">
      ...
      <div className="mb-6 relative">
        <Search
          size={16}
          className="absolute left-4 top-1/2 -translate-y-1/2 text-[hsl(var(--visual-text-muted))]"
          aria-hidden="true"
        />
        <input
          type="text"
        ...
        {filtered.map((item, i) => (
          <div key={i} className="vi-card overflow-hidden">
            ...
            >
              ...
              <ChevronDown
                size={16}
                className={`text-[hsl(var(--visual-text-muted))] transition-transform ${openIndex === i ? "rotate-180" : ""}`}
                aria-hidden="true"
              />
            </button>
            {openIndex === i && (
      ...
      <div className="vi-card p-6 bg-[hsl(var(--visual-primary)/0.06)] border-[hsl(var(--visual-primary)/0.3)]">
        ...
        <a
          href="mailto:support@aivo.learning"
          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[hsl(var(--visual-primary))] text-white text-sm font-bold hover:bg-[hsl(var(--visual-primary)/0.9)] transition"
          style={{ minHeight: 44 }}
        >
