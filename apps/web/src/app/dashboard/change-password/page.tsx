...
function reasonText(r: string): string {
  switch (r) {
    case "too_short":
      return "Too short — at least 12 characters required (14 for staff)";
    case "too_weak":
      return "Not strong enough — add more length or variety";
    case "breached":
      return "This password has appeared in a public breach";
    case "reused":
      return "You've used this password before";
    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-violet-50 flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl border border-slate-100 p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="cp-current" className="block text-sm font-semibold text-slate-700 mb-1">
              Current password
            </label>
            <input
              id="cp-current"
          ...
          <div>
            <label htmlFor="cp-new" className="block text-sm font-semibold text-slate-700 mb-1">
              New password
            </label>
            <input
              id="cp-new"
          ...
          <div>
            <label htmlFor="cp-confirm" className="block text-sm font-semibold text-slate-700 mb-1">
