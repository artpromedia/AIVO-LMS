      ...
      <div className="vi-card p-6">
        ...
        {therapyGoals.length === 0 ? (
          <p className="text-sm vi-text-muted">
            No therapy goals recorded yet. Goals will appear as they are added to learner IEP
            profiles.
          </p>
        ) : (
                ...
                {therapyGoals.map((g) => {
                  ...
                  return (
                    <tr key={g.id} className="border-b vi-border hover:vi-surface-soft">
                      <td className="py-3 px-4 font-medium vi-text">
                        {learner?.name || "Unknown"}
                      </td>
                      <td className="py-3 px-4 vi-text-muted">{g.title}</td>
                      <td className="py-3 px-4">
                        <span className="px-2 py-0.5 text-xs rounded-full bg-[hsl(var(--visual-math)/0.12)] text-[hsl(var(--visual-math))] font-bold">
                          {g.category}
                        </span>
                      </td>
                      <td className="py-3 px-4">
                        <div className="flex items-center gap-2">
                          <div
                            className="w-20 vi-surface-soft rounded-full h-1.5"
                            role="progressbar"
                          ...
                          >
                            <div
                              className="h-1.5 rounded-full bg-[hsl(var(--visual-math))]"
                      ...
                      <td className="py-3 px-4">
                        <span
                          className={`px-2 py-0.5 text-xs rounded-full font-bold ${g.status === "completed" || g.status === "met" ? "bg-[hsl(var(--visual-science)/0.12)] text-[hsl(var(--visual-science))]" : "bg-[hsl(var(--visual-sel)/0.16)] text-[hsl(var(--visual-sel))]"}`}
                        >
                          {g.status}
                        </span>
                      </td>
