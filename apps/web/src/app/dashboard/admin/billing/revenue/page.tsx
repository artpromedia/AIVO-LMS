      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm vi-text-muted mt-1">
            Track MRR, subscriber growth, and churn metrics.
          </p>
        </div>
      </div>
        ...
        {(
          [
            ...
            },
            {
              ...
              value: `$${totalSubs > 0 ? Math.round(currentMRR / totalSubs) : 0}`,
              Icon: User,
              color: "primary",
              change: "",
            },
          ...
          return (
            <div key={m.label} className="bg-white rounded-xl p-5 shadow-sm border vi-border">
              ...
              {m.change && (
                <p className="text-xs text-[hsl(var(--visual-science))] mt-1">{m.change}</p>
              )}
            </div>
          );
        })}
            ...
            return (revenueData ?? []).map((d) => {
              ...
              return (
                <div key={d.month} className="flex-1 flex flex-col items-center gap-1">
                  <span className="text-[10px] vi-text-muted font-semibold">
