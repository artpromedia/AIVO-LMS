          ...
          <div className="space-y-6">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-white/70 mt-1">
                      {tGamification("level")} {profile.level}
                    </p>
                    {profile.gradeLevel && (
                      <p className="text-white/60 text-sm">Grade {profile.gradeLevel}</p>
                    )}
                  </div>
                  <div className="ml-auto text-right">
                    <p className="text-4xl font-bold">{profile.xp.toLocaleString()}</p>
                    <p className="text-white/70 text-sm">
                      {tGamification("xp")} {tCommon("total").toLowerCase()}
                    </p>
                  </div>
                </div>
                <div className="mt-6">
                  <div className="flex items-center justify-between text-sm mb-1">
                    ...
                    <span>
                      {tGamification("level")} {profile.level + 1}
                    </span>
                  </div>
                  <div className="w-full bg-white/20 rounded-full h-3">
                    <div
                      className="h-3 rounded-full bg-white/80 transition-all"
                  ...
                  {profile.subjects.map((s, i) => (
                    <div key={i}>
                      ...
                      <div className="w-full bg-slate-100 rounded-full h-2.5">
                        <div
                          className="h-2.5 rounded-full bg-gradient-to-r from-primary to-purple-400 transition-all"
            ...
            <div className="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                <Link
                  href="/dashboard/learner/badges"
                  className="p-4 rounded-xl border border-slate-200 hover:border-primary hover:shadow-sm transition text-center"
                >
