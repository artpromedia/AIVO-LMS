...
export default function SalesDashboard() {
  ...
  const pipeline = [
    { stage: "Lead", count: 45, value: "$67,500", color: "bg-slate-200" },
    {
      ...
      count: 28,
      value: "$42,000",
      color: "bg-[hsl(var(--visual-reading)/0.35)]",
    },
    { stage: "Demo Scheduled", count: 15, value: "$22,500", color: "bg-purple-200" },
    {
      ...
      count: 8,
      value: "$12,000",
      color: "bg-[hsl(var(--visual-sel)/0.40)]",
    },
    { stage: "Negotiation", count: 5, value: "$7,500", color: "bg-[hsl(var(--visual-sel)/0.55)]" },
    {
      ...
      count: 3,
      value: "$4,500",
      color: "bg-[hsl(var(--visual-science)/0.35)]",
    },
  ];

  const recentDeals = [
    {
      name: "Fairfax County Schools",
      type: "B2B_DISTRICT",
      seats: 5000,
      value: "$125,000",
      stage: "Proposal Sent",
          ...
          <tbody>
            {recentDeals.map((deal) => (
              <tr key={deal.name} className="border-b vi-border hover:vi-bg/50 transition">
                ...
                <td className="px-5 py-3">
                  <span className="px-2 py-0.5 text-xs rounded-full font-semibold bg-[hsl(var(--visual-primary)/0.12)] text-[hsl(var(--visual-primary))]">
                    {deal.stage}
                  </span>
                </td>
