          ...
          setNotifications([
            {
              ...
              message:
                "Your account has been created. Start exploring your personalized learning journey.",
              read: false,
            ...
            },
            {
              ...
              message: "Add a learner to get started with AI-powered tutoring sessions.",
              read: false,
            ...
            },
            {
              ...
              message:
                "New tutors and quest worlds are now available. Check the tutor store for details.",
              read: true,
        ...
        setNotifications([
          {
            ...
            title: "Welcome to AIVO!",
            message:
              "Your notification center is ready. Updates about your learning journey will appear here.",
            read: false,
            createdAt: new Date().toISOString(),
          },
        ]);
      ...
      <div className="max-w-3xl mx-auto px-6 py-8">
        <header className="flex items-center gap-4 mb-6">
          ...
          <div className="flex-1">
            <h1 className="text-2xl font-heading font-bold vi-text leading-tight">
              {td("overview")}
            </h1>
            {unreadCount > 0 && (
        ...
        {loadingNotifs ? (
          <div className="vi-card p-12 text-center animate-pulse vi-text-muted">
          ...
          <div className="vi-card p-12 text-center">
            ...
            <p className="text-xs vi-text-muted mt-1">
              Updates about your learning journey will appear here.
            </p>
          </div>
        ) : (
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-2">
                        <h3
                          className={`text-sm font-semibold ${n.read ? "vi-text-muted" : "vi-text"}`}
                        >
                          {n.title}
                        </h3>
                        <div className="flex items-center gap-2 flex-shrink-0">
                          {!n.read && (
                            <span className="w-2 h-2 rounded-full bg-[hsl(var(--visual-primary))]" />
                          )}
                          <span className="text-xs vi-text-muted">{formatTime(n.createdAt)}</span>
                        </div>
                      </div>
                      <p className={`text-sm mt-0.5 ${n.read ? "vi-text-muted" : "vi-text-muted"}`}>
                        {n.message}
                      </p>
                      {n.link && (
                        <Link
                          href={n.link}
                          className="text-xs text-[hsl(var(--visual-primary))] font-semibold hover:underline mt-1 inline-block"
                        >
                          View details →
                        </Link>
                      )}
