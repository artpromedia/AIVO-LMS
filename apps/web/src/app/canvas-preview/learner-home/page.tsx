      ...
      <div className="vi-root min-h-screen">
        <header className="bg-white border-b border-slate-200/60 px-6 py-4 flex items-center justify-between sticky top-0 z-20">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[hsl(262_83%_58%)] to-[hsl(340_82%_52%)] flex items-center justify-center text-white shadow-md">
          ...
          <div className="flex items-center gap-2">
            <div className="flex items-center gap-1.5 bg-amber-50 border-2 border-amber-200 rounded-full px-3 py-1.5">
              ...
              <span className="font-extrabold text-amber-700 text-sm">{learner.coins}</span>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-3 flex-wrap">
                  ...
                  <button className="inline-flex items-center gap-2 px-5 py-3 rounded-full bg-slate-100 text-slate-700 font-bold">
