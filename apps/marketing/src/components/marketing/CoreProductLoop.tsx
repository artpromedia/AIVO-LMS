...
const steps = [
  ...
  { n: 2, title: "Parent assessment", body: "Quick context on strengths, interests, and challenges." },
  { n: 3, title: "Optional IEP context", body: "Add accommodation context if it exists." },
  { n: 4, title: "Personalized baseline", body: "A calm adaptive baseline — not a high-stakes test." },
  { n: 5, title: "Today's Mission", body: "One clear next-best learning action, every day." },
  { n: 6, title: "LessonRuns", body: "Tutor-guided lessons with hints, scaffolds, and read-aloud." },
