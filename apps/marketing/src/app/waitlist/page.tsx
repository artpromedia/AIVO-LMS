      ...
      >
        ...
        <ul className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-3">
          <li className="rounded-2xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-1 font-body text-slate-700">One email when your spot opens. Maybe a second if you don't reply.</p>
          </li>
          <li className="rounded-2xl border border-slate-200 bg-white p-5">
            <span className="font-heading text-sm font-bold text-emerald-700">No sharing</span>
            <p className="mt-1 font-body text-slate-700">We don't sell or share your contact info — ever. See our privacy policy.</p>
          </li>
          <li className="rounded-2xl border border-slate-200 bg-white p-5">
            <span className="font-heading text-sm font-bold text-emerald-700">Easy out</span>
            <p className="mt-1 font-body text-slate-700">Reply &quot;remove&quot; to any waitlist email and we delete your record.</p>
          </li>
        </ul>
      </section>
    </LandingPageLayout>
