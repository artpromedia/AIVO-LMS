...
export const metadata: Metadata = {
  ...
  description:
    "Plain-language articles on personalized learning, parent progress, baseline assessments, and accessibility supports.",
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {posts.map((p) => (
            ...
            >
              ...
              <p className="mt-3 font-body text-iw-ink-muted">{p.excerpt}</p>
