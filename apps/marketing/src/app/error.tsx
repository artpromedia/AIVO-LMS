  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-b from-purple-50/40 via-white to-white">
      ...
      <main className="mx-auto flex max-w-2xl flex-1 flex-col items-center justify-center px-6 py-20 text-center md:px-8">
        ...
        <h1 className="mt-4 font-heading text-3xl font-bold text-slate-900 md:text-4xl">Something went wrong on our end</h1>
        ...
        {error.digest && <p className="mt-2 font-body text-sm text-slate-400">Reference: {error.digest}</p>}
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          ...
          <Link href="/" className="inline-flex min-h-[44px] items-center rounded-full border border-purple-200 bg-white px-6 py-3 font-bold text-purple-700 transition hover:bg-purple-50">Home</Link>
          <Link href="/contact" className="inline-flex min-h-[44px] items-center rounded-full border border-purple-200 bg-white px-6 py-3 font-bold text-purple-700 transition hover:bg-purple-50">Contact us</Link>
        </div>
      </main>
    </div>
  );
