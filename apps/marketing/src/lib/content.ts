...
export const CONTENT: ContentArticle[] = [
  {
    ...
    body: [
      {
        type: "p",
        text: "Personalized learning is the idea that each learner is met where they are. Instead of marching the entire classroom through identical pages, the lesson responds to the learner: it slows down on the rough patches, accelerates on the strong ones, and offers the kind of support that learner actually uses.",
      },
      ...
      {
        type: "p",
        text: "The curriculum and standards do not change. The destination is the same. What changes is the route — and how much the learner enjoys the trip.",
      },
      { type: "h2", text: "What AIVO does specifically" },
      {
        type: "p",
        text: "AIVO combines a parent assessment, an optional IEP or accommodation context, a baseline assessment, and a mastery history to compose each LessonRun. The system never asks a learner to stare at a dashboard of options. It always gives one next action.",
      },
    ],
  },
  {
    ...
    body: [
      {
        type: "p",
        text: "School language can feel like a foreign country. AIVO is built so that parents do not need to learn the jargon to understand whether learning is going well.",
      },
      ...
      {
        type: "p",
        text: "Mastery score, standards alignment, scaffold tier — these are useful to teachers, but the parent summary translates them. If you ever want the underlying detail, every plain-language sentence links to the full data.",
      },
      { type: "h2", text: "The two questions worth asking" },
      {
        type: "p",
        text: 'If you only ever ask two questions, ask: "What did my child enjoy this week?" and "What got harder this week?" The first protects motivation. The second catches problems before they become invisible.',
      },
    ],
  },
  {
    ...
    body: [
      {
        type: "p",
        text: "A baseline assessment is the very first conversation AIVO has with a learner. It is short, adaptive, and gentle — not a quiz, not a grade, and not something the learner can fail.",
      },
      { type: "h2", text: "Why we do it" },
      {
        type: "p",
        text: "Without a baseline, every adaptive system is guessing. The first lessons would either bore strong learners or overwhelm struggling ones. The baseline tells the system where to start so the first real LessonRun lands at the right height.",
      },
      ...
      {
        type: "p",
        text: "Parents get a plain-language readout: what AIVO learned, where to start, and what to watch over the first two weeks.",
      },
    ],
  },
  {
    ...
    body: [
      {
        type: "p",
        text: "Good support disappears when it stops being needed. AIVO offers four support modes — read-aloud, hints, scaffolded examples, and reduced cognitive load — and the right one shows up at the right time, then steps back as the learner gains confidence.",
      },
      { type: "h2", text: "Read-aloud" },
      {
        type: "p",
        text: "Available on every lesson surface. Honors the learner's speed, voice, and pause preferences. Reading support is a learning aid, not a reading-skill substitute — AIVO continues to build decoding skill in parallel.",
      },
      { type: "h2", text: "Hints" },
      {
        type: "p",
        text: "Hints arrive when the system detects struggle, not as a shortcut button to skip the work. The hint always points toward the strategy the learner just learned, not the answer.",
      },
      { type: "h2", text: "Scaffolded examples" },
      {
        type: "p",
        text: "When a step is too tall, AIVO breaks it into smaller stairs. The learner solves each smaller piece, then the full step is offered again.",
      },
      { type: "h2", text: "Reduced cognitive load" },
      {
        type: "p",
        text: "Some learners do better with fewer items on screen, less animation, and shorter instructions. AIVO can apply all three automatically when the parent or IEP context says they help.",
      },
    ],
  },
  {
    ...
    body: [
      {
        type: "p",
        text: "AI learning tools are arriving faster than procurement teams can review them. This guide is a short, vendor-neutral checklist to use when an AI learning product lands on your desk — including this one.",
      },
  ...
  },
  {
    ...
    body: [
      {
        type: "p",
        text: "The /privacy and /trust pages cover the full posture. This guide is the short version, written for a parent or principal who has ten minutes.",
      },
      ...
      {
        type: "p",
        text: "For learners under 13, parents are the default authority. Where a school is acting as the responsible party under FERPA, parents retain inspection rights through their school.",
      },
      { type: "h2", text: "Data export and deletion" },
      {
        type: "p",
        text: "Parents can request a full export at privacy@aivolearning.com. Account deletion is permanent within 30 days of request.",
      },
      { type: "h2", text: "What we are designed to support" },
      {
        type: "p",
        text: "AIVO is designed to support COPPA and FERPA. We do not claim compliance certification we have not earned — see /security and /subprocessors for the live posture.",
      },
    ],
  },
];
