    ...
    >
      <RoleHomeScaffold
        hero={{
          ...
          subheading: "You're on the care team for the learners listed below.",
          tone: "calm",
        }}
        kpiStrip={
          <>
            <FloatingMetricCard label={t("on_care_team")} value={String(fresh.length)} tone="info" />
            <FloatingMetricCard label={t("active_or_ready")} value={String(learningNow)} tone="success" />
            <FloatingMetricCard
              label={t("quick_links")}
              value={
                <div className="mt-1 flex flex-col gap-1 text-sm text-left">
                  <Link href="/caregiver/observations" className="text-iw-text-strong hover:underline">
                    {t("link_observations")}
                  </Link>
                  <Link href="/caregiver/learners" className="text-iw-text-strong hover:underline">
                    {t("link_roster")}
                  </Link>
                </div>
              }
        ...
        sections={[
          {
            ...
            emptyState: (
              <EmptyState
                ...
                body="Once a parent invites you and you accept, the learners you support will appear here."
              />
            ),
          },
        ]}
