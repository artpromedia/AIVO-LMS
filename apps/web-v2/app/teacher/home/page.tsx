  ...
  return (
    ...
    >
      <PageHeader
        ...
        actions={<Button disabled>New assignment (Sprint 16)</Button>}
      />

      <SectionHeader
        title="Your classes"
        description="Live class rosters will appear here once Sprint 15 wires them up."
      />
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <Card className="p-[var(--aivo-density-card-pad)]">
          ...
          <p className="mt-1 text-sm text-aivo-ink-soft">
            22 learners · 3 IEPs · 2 awaiting baseline
          </p>
