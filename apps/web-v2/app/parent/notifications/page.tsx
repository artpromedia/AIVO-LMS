...
export default async function Page() {
  ...
  return (
    ...
    >
      ...
      <SectionHeader
        title="Inbox"
        description="Tap to mark as read. Unread items are highlighted."
      />
      {notifications.length === 0 ? (
        <EmptyState
          title="No notifications yet"
          description="You'll see updates here when activity occurs."
        />
      ) : (
      ...
      <SectionHeader
        ...
        description="Choose which updates reach you on each channel."
      />
