...
/**
 * Decorative hero scene for the web-v2 home page — a stylized tablet
 * showing the learner dashboard ("Hi, Jordan!") with the AIVO Virtual Brain
 * mascot waving alongside a short speech bubble.
 *
 * Ported from apps/marketing's HomeHeroDevice so the two public landing
 * pages match. The only divergence is `font-iw-display` (web-v2's display
 * font utility) in place of marketing's `font-heading`, which does not
 * resolve in this app.
 *
