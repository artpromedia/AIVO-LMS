...
export const DISTRICT_NAV: RoleNavItem[] = [
  ...
  { href: "/admin/district/impersonation", label: "View-As log", icon: <Shield className="h-4 w-4" /> },
...
export const PLATFORM_NAV: RoleNavItem[] = [
  ...
  { href: "/admin/platform/impersonation", label: "View-As log", icon: <Shield className="h-4 w-4" /> },
