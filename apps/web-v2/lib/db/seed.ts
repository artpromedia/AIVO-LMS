...
export function ensureSeeded(): void {
  ...
  const billingSeed: Array<Omit<BillingAccount, "id" | "createdAt">> = [
    ...
    { tenantId: "t_family_chen", plan: "family", status: "trialing" },
