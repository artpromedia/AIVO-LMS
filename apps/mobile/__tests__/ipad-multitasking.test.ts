...
import { classifyWidth, isTabletWidth, type SizeClass } from "../src/design/responsive";
...
const ONE_THIRD: Case[] = [
  {
    name: '1/3 split, iPad 10.2" landscape',
    width: 320,
    height: 768,
    expected: "compact",
    isTablet: false,
  ...
  {
    name: '1/3 split, iPad 11" landscape',
    width: 375,
    height: 834,
    expected: "compact",
    isTablet: false,
  ...
  {
    name: '1/3 split, iPad Pro 12.9" landscape',
    width: 375,
    height: 1024,
    expected: "compact",
    isTablet: false,
...
const ONE_HALF: Case[] = [
  {
    name: "1/2 split, iPad portrait (any)",
    width: 504,
    height: 768,
    expected: "compact",
    isTablet: false,
  ...
  {
    name: '1/2 split, iPad 10.2" landscape',
    width: 507,
    height: 768,
    expected: "compact",
    isTablet: false,
  ...
  {
    name: '1/2 split, iPad 11" landscape',
    width: 590,
    height: 834,
    expected: "compact",
    isTablet: false,
  ...
  {
    name: '1/2 split, iPad Pro 12.9" landscape',
    width: 678,
    height: 1024,
    expected: "medium",
    isTablet: true,
...
const TWO_THIRDS: Case[] = [
  {
    name: '2/3 split, iPad 10.2" portrait',
    width: 438,
    height: 1024,
    expected: "compact",
    isTablet: false,
  ...
  {
    name: '2/3 split, iPad Pro 12.9" portrait',
    width: 639,
    height: 1366,
    expected: "medium",
    isTablet: true,
  ...
  {
    name: '2/3 split, iPad 10.2" landscape',
    width: 694,
    height: 768,
    expected: "medium",
    isTablet: true,
  ...
  {
    name: '2/3 split, iPad 11" landscape',
    width: 791,
    height: 834,
    expected: "medium",
    isTablet: true,
  ...
  {
    name: '2/3 split, iPad Pro 12.9" landscape',
    width: 981,
    height: 1024,
    expected: "expanded",
    isTablet: true,
...
const FULL_SCREEN: Case[] = [
  {
    name: 'Full screen, iPad 10.2" portrait',
    width: 768,
    height: 1024,
    expected: "medium",
    isTablet: true,
  ...
  {
    name: 'Full screen, iPad Pro 12.9" portrait',
    width: 1024,
    height: 1366,
    expected: "expanded",
    isTablet: true,
  ...
  {
    name: 'Full screen, iPad 10.2" landscape',
    width: 1024,
    height: 768,
    expected: "expanded",
    isTablet: true,
  ...
  {
    name: 'Full screen, iPad Pro 12.9" landscape',
    width: 1366,
    height: 1024,
    expected: "expanded",
    isTablet: true,
...
describe("iPadOS multitasking → stage layout", () => {
  ...
  it("2/3 Split View stacks unless the pane is in expanded landscape", () => {
    for (const c of TWO_THIRDS) {
      ...
      const expectedSplit = c.expected === "expanded" || (c.expected === "medium" && isLandscape);
