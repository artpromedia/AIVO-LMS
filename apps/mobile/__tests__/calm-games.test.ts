/**
 * Calming mini-game pure logic — mobile port parity.
 *
 * Mirrors apps/web-v2/lib/learner/__tests__/calm-games.test.ts. Deterministic
 * with a seeded LCG so the tests never depend on Math.random.
 */
