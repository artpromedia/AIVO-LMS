...
/**
 * Teacher curriculum (MOB-TCH-002) — mirror of web's
 * /teacher/learners/[learnerId]/curriculum. Upload scope so AIVO syncs
 * with class instruction.
 */
export default function TeacherCurriculumScreen() {
      ...
      <Card tone="raised" style={{ gap: spacing.sm }}>
        ...
        <Text style={[styles.body, { color: palette.inkMuted }]}>
          {t("teacherCurriculum.body", {
            ...
            defaultValue: `Upload your scope & sequence so AIVO keeps ${learner?.firstName ?? "this student"} aligned with class.`,
          })}
        </Text>
        <Pressable
