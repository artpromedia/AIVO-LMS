...
export default function BrainHistoryScreen() {
  ...
  return (
    ...
    >
      ...
      <Text style={styles.title}>{t("parentBrain.brainHistory")}</Text>
      ...
      <EmptyState
        ...
        message="Brain version history will appear as your child completes learning sessions and the Brain model evolves."
      />
    </ScrollView>
  );
}
