/**
 * Cross-service pub/sub bus — family-svc copy.
 *
 ...
 *
 * family-svc publishes `caregiver.observation.created` and
 * `recommendation.suggested` so recommendation-svc can derive
