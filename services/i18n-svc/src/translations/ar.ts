...
// the i18n audit (`pnpm i18n:audit`). The /api/i18n/translations/ar
...
// longer reached for ar because the file is now present.
import { en } from "./en.js";

export const ar: Record<string, string> = { ...en };
