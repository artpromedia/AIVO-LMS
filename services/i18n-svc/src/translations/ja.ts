...
// the i18n audit (`pnpm i18n:audit`). The /api/i18n/translations/ja
...
// longer reached for ja because the file is now present.
import { en } from "./en.js";

export const ja: Record<string, string> = { ...en };
