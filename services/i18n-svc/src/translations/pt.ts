...
// the i18n audit (`pnpm i18n:audit`). The /api/i18n/translations/pt
...
// longer reached for pt because the file is now present.
import { en } from "./en.js";

export const pt: Record<string, string> = { ...en };
