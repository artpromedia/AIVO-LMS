...
// the i18n audit (`pnpm i18n:audit`). The /api/i18n/translations/hi
...
// longer reached for hi because the file is now present.
import { en } from "./en.js";

export const hi: Record<string, string> = { ...en };
