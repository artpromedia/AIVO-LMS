...
const SKILL_NODES: SkillNode[] = [
  ...
  // ── Sprint D — coding ─────────────────────────────────────────────────
  {
    code: "CODE.FOUND.SEQUENCING",
    label: "Sequencing — first / then / last",
    subject: "coding",
    prerequisites: [],
    topicKeywords: ["sequence", "order", "first", "then"],
    standards: ["CSTA.1A.AP.10"],
  },
  {
    code: "CODE.FOUND.LOOPS",
    label: "Loops — repeating an action",
    subject: "coding",
    prerequisites: ["CODE.FOUND.SEQUENCING"],
    topicKeywords: ["loop", "repeat", "again"],
    standards: ["CSTA.1A.AP.11"],
  },
  {
    code: "CODE.FOUND.CONDITIONALS",
    label: "If-then choices",
    subject: "coding",
    prerequisites: ["CODE.FOUND.SEQUENCING"],
    topicKeywords: ["if", "condition", "choice", "decision"],
    standards: ["CSTA.1A.AP.14"],
  },
  {
    code: "CODE.FOUND.DEBUG",
    label: "Find and fix a bug",
    subject: "coding",
    prerequisites: ["CODE.FOUND.LOOPS"],
    topicKeywords: ["debug", "bug", "fix", "error"],
    standards: ["CSTA.1A.AP.15"],
  },

  // ── Sprint D — speech (articulation, phonology, fluency) ─────────────
  {
    code: "SPEECH.ARTIC.SOUND_IDENT",
    label: "Identify a target speech sound",
    subject: "speech",
    prerequisites: [],
    topicKeywords: ["sound", "phoneme", "letter sound"],
    standards: ["ASHA.SLP.ARTIC.IDENT"],
  },
  {
    code: "SPEECH.ARTIC.PRODUCE",
    label: "Produce a target sound in isolation",
    subject: "speech",
    prerequisites: ["SPEECH.ARTIC.SOUND_IDENT"],
    topicKeywords: ["pronounce", "produce", "say"],
    standards: ["ASHA.SLP.ARTIC.PRODUCE"],
  },
  {
    code: "SPEECH.ARTIC.WORD_LEVEL",
    label: "Produce target sound in a word",
    subject: "speech",
    prerequisites: ["SPEECH.ARTIC.PRODUCE"],
    topicKeywords: ["word", "syllable"],
    standards: ["ASHA.SLP.ARTIC.WORD"],
  },
  {
    code: "SPEECH.FLUENCY.PACING",
    label: "Pacing and pause control",
    subject: "speech",
    prerequisites: ["SPEECH.ARTIC.WORD_LEVEL"],
    topicKeywords: ["pace", "pause", "fluency", "stutter"],
    standards: ["ASHA.SLP.FLUENCY"],
  },

  // ── Sprint D — creative_arts (visual + creative writing + music basics) ──
  {
    code: "ARTS.VIS.LINE_SHAPE",
    label: "Line and shape as building blocks",
    subject: "creative_arts",
    prerequisites: [],
    topicKeywords: ["line", "shape", "drawing"],
    standards: ["NCAS.VA.Cr1.1"],
  },
  {
    code: "ARTS.VIS.COLOR",
    label: "Color and color mixing",
    subject: "creative_arts",
    prerequisites: ["ARTS.VIS.LINE_SHAPE"],
    topicKeywords: ["color", "paint", "mix"],
    standards: ["NCAS.VA.Cr2.1"],
  },
  {
    code: "ARTS.WRITE.STORY_PARTS",
    label: "Beginning, middle, end of a story",
    subject: "creative_arts",
    prerequisites: [],
    topicKeywords: ["story", "narrative", "beginning"],
    standards: ["CCSS.W.K.3"],
  },
  {
    code: "ARTS.WRITE.DESCRIBE",
    label: "Sensory description",
    subject: "creative_arts",
    prerequisites: ["ARTS.WRITE.STORY_PARTS"],
    topicKeywords: ["describe", "senses", "imagery"],
    standards: ["CCSS.W.1.3"],
  },

  // ── Sprint D — stem_engineering (design process) ─────────────────────
  {
    code: "STEM.ENG.PROBLEM",
    label: "Define a problem",
    subject: "stem_engineering",
    prerequisites: [],
    topicKeywords: ["problem", "define", "ask"],
    standards: ["NGSS.K-2-ETS1-1"],
  },
  {
    code: "STEM.ENG.IDEATE",
    label: "Sketch possible solutions",
    subject: "stem_engineering",
    prerequisites: ["STEM.ENG.PROBLEM"],
    topicKeywords: ["sketch", "design", "ideate", "brainstorm"],
    standards: ["NGSS.K-2-ETS1-2"],
  },
  {
    code: "STEM.ENG.BUILD_TEST",
    label: "Build and test a prototype",
    subject: "stem_engineering",
    prerequisites: ["STEM.ENG.IDEATE"],
    topicKeywords: ["build", "test", "prototype"],
    standards: ["NGSS.K-2-ETS1-3"],
  },
  {
    code: "STEM.ENG.ITERATE",
    label: "Improve from what we learned",
    subject: "stem_engineering",
    prerequisites: ["STEM.ENG.BUILD_TEST"],
