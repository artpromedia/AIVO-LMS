...
import { ADMIN_ENTERPRISE, verifyJWT, getPublicKeyPEM } from "@aivo/security";
...
const RUNBOOK_BASE =
  process.env.RUNBOOK_BASE_URL || "https://github.com/aivo/aivo/blob/main/docs/runbooks";
...
export function registerComplianceRoutes(app: FastifyInstance, db: any) {
  app.get(
    ...
    { schema: getAdminSvcComplianceControlsSchema, preHandler: requireAdmin },
    async () => {
