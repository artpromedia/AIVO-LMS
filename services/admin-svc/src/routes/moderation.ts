...
import {
  adminSvcInternalModerationSchema,
  getAdminSvcModerationSchema,
  getAdminSvcModerationByIdSchema,
  patchAdminSvcModerationByIdSchema,
  getAdminSvcModerationStatsSchema,
} from "./schemas.js";
...
export function registerModerationRoutes(app: FastifyInstance, db: any) {
  ...
  app.post(
    ...
    { schema: adminSvcInternalModerationSchema, preHandler: requireInternalKey },
    async (request, reply) => {
  ...
  app.get(
    ...
    { schema: getAdminSvcModerationSchema, preHandler: requirePlatformAdmin },
    async (request) => {
  ...
  app.get(
    ...
    { schema: getAdminSvcModerationByIdSchema, preHandler: requirePlatformAdmin },
    async (request, reply) => {
  ...
  app.patch(
    "/api/admin-svc/moderation/:id",
    { schema: patchAdminSvcModerationByIdSchema, preHandler: requirePlatformAdmin },
    async (request, reply) => {
      const { id } = request.params as any;
  ...
  app.get(
    ...
    { schema: getAdminSvcModerationStatsSchema, preHandler: requirePlatformAdmin },
    async () => {
