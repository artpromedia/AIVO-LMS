...
export const webhookEventsReceived = createCounter("billing_webhook_events_received_total", [
  "type",
]);

export const webhookEventsDuplicate = createCounter("billing_webhook_events_duplicate_total", [
  "type",
]);

export const webhookEventsStale = createCounter("billing_webhook_events_stale_total", ["type"]);

export const webhookEventsProcessed = createCounter("billing_webhook_events_processed_total", [
  "type",
  "outcome",
]);

export const checkoutSessionsCreated = createCounter("billing_checkout_sessions_created_total", [
  "plan",
]);

export const portalSessionsCreated = createCounter("billing_portal_sessions_created_total");
...
export const reconciliationRuns = createCounter("billing_reconciliation_runs_total", ["outcome"]);
