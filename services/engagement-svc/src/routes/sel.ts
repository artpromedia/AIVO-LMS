...
import {
  selCheckinSchema,
  getSelCheckinsByLearnerIdSchema,
  getSelExercisesByEmotionSchema,
  getBreaksCatalogSchema,
  breakLogSchema,
  getBreaksByLearnerIdSchema,
} from "./schemas.js";

const GUIDED_EXERCISES: Record<
  string,
  { title: string; steps: string[]; durationMinutes: number }[]
> = {
  sad: [
    {
      ...
      steps: [
        ...
        "Imagine a rainbow appearing with each breath",
        "Repeat 5 times",
      ],
      durationMinutes: 3,
    },
    {
      ...
      steps: [
        ...
        "Draw or imagine each one as a flower",
        "Describe the color of each flower",
  ...
  frustrated: [
    {
      title: "Volcano Calm-Down",
      steps: [
        "Stand up tall like a volcano",
        "Breathe in deeply — feel the 'lava' rising",
        "Now breathe out slowly and let the lava cool",
        "Shake out your hands",
        "Roll your shoulders",
        "The volcano is calm now!",
      ],
      durationMinutes: 3,
    },
    {
  ...
  tired: [
    ...
    {
      title: "Power Nap Visualization",
      steps: [
        "Rest your head on your arms",
        "Close your eyes",
        "Imagine floating on a cloud",
        "The cloud gently carries you over a beautiful forest",
  ...
  happy: [
    {
      title: "Share the Joy",
      steps: [
        "Think about why you're happy",
        "Draw a picture of your happy moment",
        "Share it with someone if you'd like",
  ...
  excited: [
    {
      ...
      steps: [
        ...
        "Set a small goal related to your excitement",
        "Do a quick stretch",
        "Ready to focus!",
      ],
      durationMinutes: 3,
...
const BREAK_ACTIVITIES_CATALOG = [
  ...
  },
  {
    type: "breathing",
    name: "Star Breathing",
    description: "Trace a star shape while breathing in on one line and out on the next.",
    durationSeconds: 90,
    trigger: "stress_high",
  },
  {
    type: "movement",
    name: "Desk Stretches",
    description: "Stretch arms, neck, and shoulders without leaving your seat.",
    durationSeconds: 120,
    trigger: "attention_low",
  },
  {
    type: "movement",
    name: "Animal Walks",
    description: "Bear walk, crab walk, frog jump — move like animals around your space!",
    durationSeconds: 180,
    trigger: "energy_high",
  },
  {
    type: "sensory",
    name: "Calm Corner",
    description: "Find a quiet spot. Listen to calming sounds for 2 minutes.",
    durationSeconds: 120,
    trigger: "overwhelm",
  },
  {
    type: "sensory",
    name: "Fidget Time",
    description: "Use a fidget tool, squeeze a stress ball, or play with putty.",
    durationSeconds: 120,
    trigger: "restless",
  },
  {
    type: "creative",
    name: "Quick Doodle",
    description: "Draw anything you want for 2 minutes. No rules!",
    durationSeconds: 120,
    trigger: "attention_low",
  },
  {
    type: "creative",
    name: "Story Starter",
    description: "Start a story with 'Once upon a time...' and write 3 sentences.",
    durationSeconds: 120,
    trigger: "attention_low",
  },
  {
    type: "mindfulness",
    name: "Body Scan",
    description: "Close your eyes. Notice how each part of your body feels, from toes to head.",
    durationSeconds: 180,
    trigger: "stress_high",
  },
  {
...
export function registerSelRoutes(
  ...
  app.get(
    ...
    { schema: getSelCheckinsByLearnerIdSchema },
    async (request, reply) => {
      const claims = await authenticateRequest(request, reply);
      if (!claims) return;
  ...
  app.get(
    ...
    { schema: getSelExercisesByEmotionSchema },
    async (request, reply) => {
      const claims = await authenticateRequest(request, reply);
      if (!claims) return;
  ...
  app.get(
    ...
    { schema: getBreaksByLearnerIdSchema },
    async (request, reply) => {
      const claims = await authenticateRequest(request, reply);
      if (!claims) return;
